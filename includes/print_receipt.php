...
function fetchdata($initials,$user,$currency,$conn){
    ...
    $output = '';
        while($fetch = mysqli_fetch_assoc($query)){
            ...
            $output .= '<table cellpadding="3px;" style="border-bottom:0.5 dashed #000">
                    <tbody> 
                    
                             <tr>
                             <td style="width:10%"></td>
                             <td style="width:10%;"><img src="../image_uploads_crests/'.$school_logo.'"  /></td>
                             <td style=" font-family:arial;width:60%; text-align:center;"><strong><span style="font-size:24px;">'.$school_name.'</span></strong><br/><br/>'.$shcool_numbers.'<br/>
                            ...
                            <tr><td style="font-size:13px; font-family:arial;width:70%;"></td>
