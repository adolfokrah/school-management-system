...
<html>
    <head>
        ...
        <title>Easyskul - CMS::Library History</title>
...
<?php include '../includes/cms_header.php';
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        <div class="col-sm-12">
                            <form action="library_history.php" method="get" class="form-inline" role="form">
                        ...
                        <div class="col-sm-12" style="padding-top:20px;">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">CMS / School Fees /</span> <span style="color:#3c8dbc">Daily Fees Records - <strong> <?php echo $from;?> - <?php echo $to;?></strong></span>
                                </div>
                            </div>
                        ...
                        <tbody id="result_box">
                            ...
                            <?php
                                 $results = '';
                                $counter  = 0;
                                $query_pick_fees = mysqli_query($conn,"select * from `library_books_status` where `DATE GIVEN` between '$from' and '$to' and `SCHOOL`= '$initials' order by `STUDENT NAME` asc");
                                ...
                                while($fetch = mysqli_fetch_assoc($query_pick_fees)){
                                    ...
                                    $counter ++;
                                        ...
                                        <td>'.htmlentities($fetch['BOOK NUMBER']).'</td>
                                        <td>'.htmlentities($fetch['SHELF NUMBER']).'</td>
                                        <td>'.htmlentities($fetch['STUDENT ID']).'</td>
                                        <td>'.htmlentities($fetch['STUDENT NAME']).'</td>
                                        <td>'.$fetch['DATE GIVEN'].'</td>
                                        <td>'.$fetch['TIME GIVEN'].'</td>
                                        <td>'.$fetch['DATE RETURNED'].'</td>
                                        <td>'.$fetch['TIME RETURNED'].'</td>
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(19) ul li:nth-child(3)').toggleClass('active');
             });
