...
<html>
    <head>
        ...
        <title>Easyskul - CMS::Sammary Reports</title>
             ...
             <?php include '../includes/cms_header.php'?>       
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        <div class="col-sm-12">
                            <form action="sammary_report.php" method="get" class="form-inline" role="form">
                        ...
                        <div class="col-sm-12" style="padding-top:20px;">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">CMS / SUMMARY REPORT /</span> <span style="color:#3c8dbc"><strong> <?php echo $from;?> - <?php echo $to;?></strong></span>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12" style="padding-top:20px;">
                                        ...
                                        <iframe src="print_sammary_report.php?from_date=<?php echo $from;?>&to_date=<?php echo $to;?>"  style="width:100%;" id="frame">
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(14)').toggleClass('active');
             });
