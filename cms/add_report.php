...
<html>
    ...
    <body>
        ...
        if(mysqli_num_rows($query_check2)==null){
            echo "<script>window.open('grading_sys.php','_self');</script>";
            ...
            if($fetch_year = mysqli_fetch_assoc($query_select_academic)){
                ...
                $term = $fetch_year['TERM'];
                        ...
                        <div class="col-sm-12">
                            <form action="add_report.php" method="get">
                           ...
                           <button type="submit" class="btn btn-default">Search</button>
                               ...
                               <button type="button" class="btn btn-primary pull-right"   style="margin-left:10px;"  data-toggle="modal" data-target="#report_box" id="generate_btn">Generate Report</button>
                                
                        </form>
                            <br/>
                             <label style="color:red">Please make sure you set grading system before generating report.click <a href="grading_sys.php" style="color:blue">here</a> to set grading system</label>
    ...
    if(mysqli_num_rows($query_pick)!=null){
                                             ...
                                             $query = mysqli_query($conn,"select * from `terminal_reports_av` where  `SCHOOL`='$initials' and `SMS SENT`='' and `CLASS`='$initial_class' and `TERM`='$term' and `ACADEMIC YEAR`='$academic_year'");
                                ...
                                <div class="panel-group" >
                                    <div class="panel panel-success">
                                            ...
                                            You have '.$number.' sms to be sent.<span class="badge badge-primary" style="cursor:pointer" onclick="send_terminal_report_sms(\''.$initial_class.'\');" id="sms_btn">send</span> <i class="fa fa-close pull-right" style="cursor:pointer" onclick="close_hint(\'#hint_box\')"></i>
                                        </div>     
                                    </div>
                                </div>
                            </div>';
                           ...
                           <div class="content">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">CMS / Terminal Report /</span> <span style="color:#3c8dbc">Geneate Report - <strong><?php echo $initial_class;?></strong></span>
                                </div>
                            </div>
    ...
    while($fetch1 = mysqli_fetch_assoc($query1)){
        ...
        $counter ++;
        $btn = '';
        $query2 = mysqli_query($conn,("select * from terminal_reports where `STUDENT ID`='$student_id' and `CLASS`='$initial_class' and `ACADEMIC YEAR`='$academic_year' and `TERM`='$term'"));
              ...
              '.$btn.'
                        ...
                        <tr>
                          ...
                          <th>ACTION</th>
                                        ...
                                        <a href="print_terminal_report_bulk.php?class=<?php echo $initial_class ?>&academic_year=<?php echo $academic_year?>&term=<?php echo $term ?>" target="_blank"><button class="btn btn-danger" ><i class="fa fa-print"></i> Print All</button></a>
                                    </div>
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(16) ul li:nth-child(1)').toggleClass('active');
             });
