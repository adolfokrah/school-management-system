...
<div id="box">
                ...
                <div class="content">
                    ...
                    $query_select2 = mysqli_query($conn,"select * from admitted_students where `SCHOOL`='$initials'");
                    ...
                    $query_select4 = mysqli_query($conn,"select * from `users` where `SCHOOL`='$initials'");
                    $number_of_staffs =0;
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                      ...
                      <div class="small-box bg-red">
                        ...
                        <a href="manage_staffs.php" class="small-box-footer">
                          More info <i class="fa fa-arrow-circle-right"></i>
                        </a>
                      </div>
                    </div>
                            ...
                            <div class="box-body pad">
                               <form>
                                <textarea class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="notice_box" data-toggle="tooltip" data-placement="top" title="Type any infomation who want to post to the noticeboard.">
                                  ...
                                  <button class="btn btn-primary pull-left" id="publish_btn" onclick="add_notice()" data-toggle="tooltip" data-placement="top" title="Click here to add infomation to the noticebord.">Publish</button>
                              </form>
                            </div>
                          </div>
                        </div>
                                ...
                                <div class="content">
                                    <div class="col-sm-12 col-md-5">
                                        ...
                                        <?php
                                            ...
                                            $query_select_transport_fee = mysqli_query($conn,"select * from transport_fee where `SCHOOL`='$initials' and `DATE`='$get_current_date'");
                                            $transport_fee=0;
