                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">CMS / Student /</span> <span style="color:#3c8dbc">Add New Student</span>
                                </div>
                            </div>
                            ...
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                         <span style="color:red">Note: fields with * are mandatory</span>
                                         <a href="STUDENT_PFOFILE.pdf" target="_blank"><button class="btn btn-danger" type="button"><i class="fa fa-download"></i> Download blank template</button></a>
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="former_school" placeholder="Name of Former School (Optional)">
                                            </div><br/>
                                            
                                            <div class="form-group" style="margin-top:-20px;">
                                                <label><small>Present class: </small></label><br/>
                                               <select class="selectpicker" data-show-subtext="true" data-live-search="true" style="width:100%;" id="class">
                                                <?php
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Admission Fee" id="fee" data-toggle="tooltip" data-placement="top" title="Plese note: Amount inputed here cannot be edited after student is been added."/>
                                            </div>
                                            <div class="form-group"> 
                                                <div class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" style="width:100%">
                                            ...
                                            <div class="form-group">
                                                <button type="button" class="btn btn-default pull-right" id="configure_cam" data-toggle="modal" data-target="#camera"><i class="fa fa-camera" ></i> Take A Photo</button>
                                                <label for="file" class="btn btn-default " onclick="upload_student_image_from_explorer();" id="choose_pic"><i class="fa fa-upload"></i> Choose A Photo</label>
                                                <input type="file" id="file" style="display:none" accept="image/*" name="file"/>
                                            </div>
                                            <div class="form-group">
                                                <button type="button" class="btn btn-block btn-primary"  onclick="add_new_student();" id="add_student" ><i class="fa fa-plus" ></i> Add Student</button>
                                            </div>
                                        </div>
