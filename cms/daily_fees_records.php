...
<?php include '../includes/cms_header.php';
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        <div class="col-sm-12">
                            <form action="daily_fees_records.php" method="get" class="form-inline" role="form">
                        ...
                        <div class="col-sm-12" style="padding-top:20px;">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b"><?php echo $username; ?> CMS / School Fees /</span> <span style="color:#3c8dbc">Daily Fees Records - <strong> <?php echo $from;?> - <?php echo $to;?></strong></span>
                                </div>
                            </div>
                        ...
                        <tbody id="result_box">
                            ...
                            <?php
                                 $results = '';
                                $counter  = 0;
                                $query_pick_fees = mysqli_query($conn,"select * from daily_fees_payments where `DATE` between '$from' and '$to' and `SCHOOL`= '$initials' and `STUDENT NAME` !=''  order by  `TERM` and `STUDENT NAME` asc");
                                ...
                                while($fetch = mysqli_fetch_assoc($query_pick_fees)){
                                    ...
                                    $counter ++;
                                        ...
                                        <td>'.$fetch['TIME'].'</td>
                                        <td>'.sprintf('%0.2f',$fetch['AMOUNT PAID']).'</td>
                    ...
                    <ul class="dropdown-menu" id="dropdown" class="dropdown">
                        ...
                        <li onclick="delete_daily_fee(\''.$id.'\',\''.$from.'\',\''.$to.'\');" '.$btn_style.'><i class="fa fa-trash"></i> Delete</li>
                        
                        <a href="print_receipt.php?id='.$id.'" target="_blank"><li><i class="fa fa-print"></i> Print receipt</li></a>
                        ...
                        <tr>
                          ...
                          <th>ACTION</th>
                                        ...
                                        <a href="print_daily_fess_report.php?from=<?php echo $from;?>&to=<?php echo $to;?>" target="_blank"><button type="button" class="btn btn-danger"><i class="fa fa-print"></i> Generat Report</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(9) ul li:nth-child(4)').toggleClass('active');
             });
