...
<html>
    <head>
        ...
        <title>Easyskul - CMS::Daily Fees Records</title>
...
<?php include '../includes/cms_header.php';
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        <div class="col-sm-12">
                            <form action="feeding_fee_history.php" method="get" class="form-inline" role="form">
                        ...
                        <div class="col-sm-12" style="padding-top:20px;">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b"><?php echo $username; ?> CMS / Feeding /</span> <span style="color:#3c8dbc"> Fee History - <strong> <?php echo $from;?> - <?php echo $to;?></strong></span>
                                </div>
                            </div>
                        ...
                        <tbody id="result_box">
                            ...
                            <?php
                                 $results = '';
                                $counter  = 0;
                                $query_pick_fees = mysqli_query($conn,"select * from daily_feeding_fee where `DATE` between '$from' and '$to' and `SCHOOL`= '$initials' order by  `TERM` and `STUDENT NAME` and `CLASS` asc");
                                ...
                                while($fetch = mysqli_fetch_assoc($query_pick_fees)){
                                    ...
                                    $counter ++;
                                        ...
                                        <td>'.$fetch['DAYS'].'</td>
                                         ...
                                         <td>
                                         <button class="btn btn-danger" data-target="#edit_feeding" data-toggle="modal" '.$btn_style.' onclick="fetch_feeding_fee_records(\''.$fetch['STUDENT ID'].'\',\''.$fetch['ID'].'\',\''.$from.'\',\''.$to.'\');"><i class="fa fa-trash"></i> Delete</button>
                                         </td>
                    ...
                    <ul class="dropdown-menu" id="dropdown" class="dropdown">
                        ...
                        <a href="print_feeding_history.php?from=<?php echo $from?>&to=<?php echo $to;?>&class=" target="_blank"><li>From selected date</li></a>
                    </ul>
              </div>
                           ...
                           <select class="selectpicker" data-show-subtext="true" data-live-search="true" style="width:100%;" id="class" name="class">
                            <?php
                             ...
                             <div class="form-group" style="margin-top:25px;">
                                 <button class="btn btn-danger" onclick="print_feeding_history('<?php echo $from?>','<?php echo $to?>')" type="button"><i class="fa fa-print"></i> Generte report</button>
                             </div>
                         </form>
                     </div>
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(10) ul li:nth-child(2)').toggleClass('active');
             });
