...
<html>
    <head>
        ...
        <title>Easyskul - CMS::Parents' Portal</title>
                     ...
                     <div class="content">
                         <div class="col-xs-12 col-sm-6 col-md-3">
                          ...
                          <div class="small-box bg-aqua">
                            ...
                            <a href="student_fees.php" class="small-box-footer">
                         ...
                         <div class="col-xs-12 col-sm-6 col-md-3">
                          ...
                          <div class="small-box bg-green">
                            <div class="inner">
                              ...
                              <p style="color:white">Attedance History</p>
                            </div>
                            <div class="icon">
                              <i class="fa fa-calendar"></i>
                            </div>
                            <a href="student_attendance_history.php" class="small-box-footer">
                              More info <i class="fa fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                         ...
                         <div class="col-xs-12 col-sm-6 col-md-3">
                          ...
                          <div class="small-box bg-yellow">
                            <div class="inner">
                              ...
                              <p style="color:white">Terminal Reports</p>
                              
                            </div>
                            <div class="icon">
                              <i class="fa fa-folder"></i>
                            </div>
                            <a href="student_terminal_reports.php?student_id=<?php echo $p_student_id;?>" class="small-box-footer">
                              More info <i class="fa fa-arrow-circle-right"></i>
                                <span class="pull-right-container" >
                                  <span class="label label-danger pull-right" data-toggle="tooltip" data-placement="left" title="You have <?php echo $new; ?> new report(s)" style="margin-right:10px;"><?php echo $new;?></span>
                            </span>
                            </a>
                        </div>
                    </div>
                         ...
                         <div class="col-xs-12 col-sm-6 col-md-3">
                          ...
                          <div class="small-box bg-red">
                            <div class="inner">
                              ...
                              <p style="color:white">Ward's Profile</p>
                            </div>
                            <div class="icon">
                              <i class="fa fa-graduation-cap"></i>
                            </div>
                            <a href="student_profile.php?student_id=<?php echo $id;?>" class="small-box-footer">
                              More info <i class="fa fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
