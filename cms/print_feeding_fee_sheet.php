...
function fetchdata($initials,$conn){
    ...
    if(isset($_GET['class']) && !empty($_GET['class'])){
            ...
            $output = '<table cellpadding="5px;" style="border:0.5 dashed #000">
                    <tbody> 
                        ...
                        <tr>
                            ...
                            <td style="border:0.5px solid #000; font-size:13px;; text-align:center; width:100%"><strong>FEEDING FEE PAYMENT SHEET</strong></td>
                        ...
                        <tr>
                            ...
                            <td style="border:0.5px solid #000; font-size:13px;; width:10%"><strong>AMOUT PAYING</strong></td>
                            <td style="border:0.5px solid #000; font-size:13px;; width:10%; text-align:center"><strong>DAYS LEFT</strong></td>
                            <td style="border:0.5px solid #000; font-size:13px;; width:10%; text-align:center"><strong>DAYS</strong></td>
                            <td style="border:0.5px solid #000; font-size:13px;; width:10%; text-align:center"><strong>BALANCE</strong></td>
                            <td style="border:0.5px solid #000; font-size:13px;; width:10%; text-align:center"><strong>ARREAS</strong></td>
        ...
        while($fetch = mysqli_fetch_assoc($query)){
            ...
            $days_left = 0;
            $query_pick_days_left = mysqli_query($conn,"select * from feeding_fee where `SCHOOL`='$initials' and `STUDENT ID`='".$fields[2]."'");
            if($fetch_days = mysqli_fetch_assoc($query_pick_days_left)){
             ...
             $output .='
                        <tr>
                            ...
                            <td style="border:0.5px solid #000; font-size:13px;;  width:20%">'.$fields[2].'</td>
                            ...
                            <td style="border:0.5px solid #000; font-size:13px;; width:10%"></td>
                            <td style="border:0.5px solid #000; font-size:13px;; width:10%">'.$fields[3].'</td>
                            <td style="border:0.5px solid #000; font-size:13px;; width:10%">'.$fields[4].'</td>
                        </tr>
                     ';
