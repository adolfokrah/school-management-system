...
<html>
    <head>
        ...
        <title>Easyskul - CMS::Read Notice</title>
    ...
    <body>
        ...
        <div class="wrapper">
            <!-- Sidebar Holder -->
            <?php 
            $users = array("Teacher","School Head","Accountant","Student","Libarian","Parent");
        ...
        ?>
                        ...
                        <div class="panel-group">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">CMS / Read Notice</span>
                                </div>
                            </div>
                        </div>
          ...
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Notice Board
              </h3>
                ...
                <?php 
                    ...
                    $notice = '';
                    $num_row = 0;
                    $num_row = mysqli_num_rows(mysqli_query($conn,"select * from noticeboard"));
                    if(isset($_GET['id']) && !empty($_GET['id'])){
                        ...
                        $query = mysqli_query($conn,"select * from noticeboard limit ".($counter - 1).",$counter");
                        if($fetch = mysqli_fetch_assoc($query)){
                             $notice = $fetch['INFO']; 
                        }
                    }
              ...
              <div class="pull-right box-tools ">
                  <?php 
                    if($counter <= 1){
                        echo '<a href="read_notice.php?page='.($counter-1).'"><button class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Previous" disabled><i class="fa fa-angle-left" ></i></button></a> ';
                    }else{
                        echo '<a href="read_notice.php?page='.($counter-1).'"><button class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Previous"><i class="fa fa-angle-left"></i></button></a> ';
                    }
                    if($num_row <= $counter){
                        echo '<a href="read_notice.php?page='.($counter+1).'"><button class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Next" disabled><i class="fa fa-angle-right" ></i></button></a> ';
                    }else{
                        echo '<a href="read_notice.php?page='.($counter+1).'"><button class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Next"><i class="fa fa-angle-right" ></i></button></a> ';
                    }
                  ?>
        ...
        <script src="bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
         ...
         <script type="text/javascript">
             ...
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(18) ul').attr('aria-expanded','true');
                 $('.list-unstyled li:nth-child(18) a').attr('aria-expanded','true');
                 $('.list-unstyled li:nth-child(18) ul').toggleClass('collapse in');
                 $('.list-unstyled li:nth-child(18) a').toggleClass('');
                 $('.list-unstyled li:nth-child(18) ul li:nth-child(1)').toggleClass('active');
             });
