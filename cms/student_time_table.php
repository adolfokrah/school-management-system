...
<?php include '../includes/cms_header.php';
        ...
        if($fetch_row = mysqli_fetch_assoc($query_pick)){
            ...
            $term = $fetch_row['TERM'];
                                    ...
                                    ?>
                                    <span style="color:#6b6b6b">CMS / My Time Table /</span> <span style="color:#3c8dbc">  Student ID - <?php echo $p_student_id;?> - Academic year: <?php echo $academic_year?> - Term: <?php echo $term;?> </span>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="box box-primary">
                                        <div class="box-header with-border">
                                          <h3 class="box-title">MY CLASS TIME TABLE
                                          </h3>
                                        ...
                                        <div class="box-body pad">
                                            <?php 
                                                $query_pick_fees_records = mysqli_query($conn,"select * from time_table where `SCHOOL`='$initials' and `ACADEMIC YEAR`='$academic_year' and `TERM`='$term'");
                                            ...
                                            echo '<object data="time_tables/'.$file.'" type="application/pdf" width="100%" height="700px"></object> ';
                                                }echo '<h5>No time table found.</h5>';
                                            ?>
                                        </div>
