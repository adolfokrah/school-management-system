...
<head>
    ...
    <title>Easyskul - CMS::Accepted SMS </title>
                        ...
                        <div class="panel-group">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">Administrator CMS / SMS /</span> <span style="color:#3c8dbc">Accepted</span>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body" style="overflow-x:scroll">
                                                <table id="example" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody id="result_box">
                                                        <?php $counter = 0;
    $query = mysqli_query($conn,"select * from `payment_invoices` where `OPERATION`='SMS CREDIT' and `status`='accepted' order by `ID` asc");
