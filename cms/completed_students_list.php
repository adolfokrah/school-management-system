            ...
            $output = '<table cellpadding="5px;" style="border:0.5 dashed #000">
                    <tbody> 
                        ...
                        <tr>
                            ...
                            <td style="border:0.5px solid #000; font-size:10px; text-align:center; width:100%"><strong>COMPLETED STUDENTS</strong></td>
                            
                        </tr>
                        <tr>
                            <td style="border:0.5px solid #000; font-size:10px; width:100%; text-align:center"><strong>'.$academic_year.'</strong></td>
                        </tr>
                        <tr>
                            
                            <td style="border:0.5px solid #000; font-size:10px; width:10%"><strong>#</strong></td>
                            <td style="border:0.5px solid #000; font-size:10px; width:30%"><strong>STUDENT ID</strong></td>
                            <td style="border:0.5px solid #000; font-size:10px; width:60%"><strong>STUDENT NAME</strong></td>
                        </tr>
                    
                ';
        
        $counter = 0;
        $query = mysqli_query($conn,"select * from `admitted_students` where `YEAR OF COMPLESTION` = '$academic_year' and `SCHOOL`='$initials' order by `STUDENT LAST NAME` asc");
        while($fetch = mysqli_fetch_assoc($query)){
            ...
            $output .='
                        ...
                        <tr>
                            ...
                            <td style="border:0.5px solid #000; font-size:10px; width:10%">'.$counter.'</td>
                            <td style="border:0.5px solid #000; font-size:10px;  width:30%">'.$fields[2].'</td>
                            <td style="border:0.5px solid #000; font-size:10px;  width:60%">'.$fields[1].' '.$fields[0].'</td>
                        </tr>
                    ';
...
$pdf->SetTitle('COMPLETED STUDENTS');
