...
<html>
    <head>
        ...
        <title>Easyskul - CMS::Manage Student</title>
    ...
    <body>
        ...
        <div class="wrapper">
            <!-- Sidebar Holder -->
            <?php 
            $users = array("Administrator","Data Entry","School Head","Teacher");
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        if(isset($_GET['class']) && !empty($_GET['class'])){
                            ...
                            if(strpos($user,'TCH')){
                                //CHECK IF TEACHER IS FOR THE CLASS
                                $check = mysqli_query($conn,"select * from teachers where `TEACHER ID`='$user' and `TEACHER CLASS`='$initial_class'");
                                if(mysqli_num_rows($check) < 1){
                                    die("You don't have permission to view other class list");
                                }
                                if($initial_class == "NONE"){
                                    die("You are not assign to any class yet.");
                                }
                            }
                        }else{
                                $initial_class = '';
                          ...
                          <div class="form-group">
                           ...
                           <select class="selectpicker" data-show-subtext="true" data-live-search="true" style="width:100%;" id="class" name="class">
                            <?php
                               ...
                               <button type="submit" class="btn btn-default" <?php echo $btn_style1?> >Search</button>
                          </div>
                          
                              <div <?php echo $btn_style?> class="form-group pull-right">
                                  <label>Select Class</label><br/>
                                <select class="selectpicker" data-show-subtext="true" data-live-search="true" style="width:100%;" id="change_class">
                            ...
                            <?php
                               ...
                               ?>
                                  ...
                                  <button type="button" class="btn btn-default" id="drop" onclick="change_student_class();"  <?php echo $btn_style1?>>Change Class</button>
                                  </div>
                        </form>
                        </div>
                           ...
                           <div class="content">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">Administrator CMS / Student /</span> <span style="color:#3c8dbc">Manage Students - <strong><?php echo $initial_class;?></strong></span>
                                </div>
                            </div>
                            ...
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body" style="overflow-x:auto">
                                        <button class="btn btn-danger" onclick="delect_all_students('<?php echo $initial_class ?>')" id="delete_all_students"><i class="fa fa-trash"></i> Delete All</button>
              ...
              <div class="dropdown" >    
                <button class="btn btn-default"  data-toggle="dropdown" id="drop">Action <span class="caret"></span></button>
                    <ul class="dropdown-menu" id="dropdown" class="dropdown">
                        ...
                        ';
        if(!strpos($user,'TCH')){
            echo '<li onclick="delete_student(\''.$id.'\',\''.$initial_class.'\');" '.$btn_style.'><i class="fa fa-trash" ></i> Delete</li>
                        <li data-toggle="modal" data-target="#edit_student" onclick="show_student_details(\''.$id.'\');" '.$btn_style.'><i class="fa fa-edit"></i> Edit</li>';
        }
            echo'
                        <a href="student_profile.php?student_id='.$id.'"><li><i class="fa fa-book"></i> Veiw Profile</li></a>
                        ...
                        <tr>
                          ...
                          <th>ACTION</th>
                                        ...
                                        <?php 
                                            if($initial_class != "COMPLETED STUDDENTS"){
                                               echo '<a href="print_students_list.php?action=class_list&class='.$initial_class.'" target="_blank"><button type="button" class="btn btn-danger"><i class="fa fa-print"></i> Generate report</button></a>'; 
                                            }
                                        ?>
...
<!--modl boxes-->
        ...
        <div class="modal-loader">
            <center><img src="../web_images/Eclipse-1s-200px.gif"></center>
        </div>
                     ...
                     <div class="modal-body">
                         <form role="form" id="form" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            ...
                                            <hr/>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Admission Fee" id="fee" readonly/>
                                            </div>
                                            <div class="form-group"> 
                                                <div class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" style="width:100%">
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(5) ul li:last-child').toggleClass('active');
             });
