...
<html>
    <head>
        ...
        <title>Easyskul - CMS::Bill Fees</title>
...
<?php include '../includes/cms_header.php';
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        <div class="col-sm-12">
                            <form action="bill_fees.php" method="get">
                           ...
                           <button type="submit" class="btn btn-default">Search</button>
                               ...
                               <button type="button" class="btn btn-default pull-right" id="drop" onclick="bill_fees('<?php echo $initial_class?>');">Bill Fess</button>
                        </form>
                        </div>
                        <div class="content">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b"><?php echo $username;?> CMS / School fees /</span> <span style="color:#3c8dbc">Bill Fees - <strong><?php echo htmlentities($initial_class);?></strong></span>
                                </div>
                            </div>
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(9) ul li:first-child').toggleClass('active');
             });
