...
function fetchdata($initials,$user,$student_id,$academic_year,$term,$conn){
        ...
        $promotion = false;
                ...
                $grades .=' </tbody></table>
                   ...
                   <table>
                    <thead>
                        ...
                        <th style="width:15%; border:0.5px solid #000; font-size:13px;; text-align:center;"><strong>GRADING CODE</strong></th>
                        <th style="width:10%; border:0.5px solid #000; font-size:13px;; text-align:center;"><strong>GRADE</strong></th>
                        <th style="width:20%; border:0.5px solid #000; font-size:13px;; text-align:center;"><strong>REMARKS</strong></th>
                        <th style="width:25%"></th>
            ...
            $output = '
                ...
                <div >
                    <div > 
                          <div style="border:2px dashed #000; font-size:13px;; border-radius:20px; padding:10px;" class="row">
                             <div class="col-xs-3"><img src="../image_uploads_crests/'.$school_logo.'" class="img img-responsive"/></div>
                             <div style="font-size:13px;;  text-align:center" class="col-xs-6"><strong>'.$school_name.'</strong><br/>'.$school_moto.'<br/>'.$schoo_location.'<br/>'.$shcool_numbers.'</div> 
                          ...
                          <div class="row" style=" border:thin solid #000; ">
                            ...
                            <div class="row" id="box">
                                     ...
                                     <table >
                                  <thead>
                                    <th style="border:0.5px solid #000; width:20%; font-size:13px;;"><strong>SUBJECT</strong></th>
                                    <th style="border:0.5px solid #000; width:15%; font-size:13px;;text-align:center;"><strong>CLASS SCORE <br/>'.$class_mark.'%</strong></th>
                                    <th style="border:0.5px solid #000; width:15%; font-size:13px;;text-align:center;"><strong>EXAM SCORE <br/>'.$exam_mark.'%</strong></th>
                                    <th style="border:0.5px solid #000; width:15%; font-size:13px;;text-align:center;"><strong>TOTAL SCORE <br/>100%</strong></th>
                                    <th style="border:0.5px solid #000; width:10%; font-size:13px;;text-align:center;"><strong>GRADE</strong></th>
                                    <th style="border:0.5px solid #000; width:10%; font-size:13px;;text-align:center;"><strong>POSITION IN SUB.</strong></th>
                                    <th style="border:0.5px solid #000; width:15%; font-size:13px;;text-align:center;"><strong>REMAKRS</strong></th>
