             ...
             <?php include '../includes/cms_header.php';
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        <div class="col-sm-12">
                            <form action="promotion_status.php" method="get" class="form-inline" rol="form">
                        ...
                        <div class="col-xs-12">
                            <iframe src="print_promotion_status.php?class=<?php echo $initial_class?>&academic_year=<?php echo $academic_year?>&term=<?php echo $term ?>" style="width:100%;" id="frame"></iframe>
                        </div>
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(16) ul li:nth-child(4)').toggleClass('active');
             });
