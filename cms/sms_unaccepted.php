...
<head>
    ...
    <title>Easyskul - CMS::Unaccepted SMS</title>
...
<body>
                                ...
                                <div class="panel-group">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <span style="color:#6b6b6b">Administrator CMS / SMS /</span> <span style="color:#3c8dbc">Unaccepted</span>
                                        </div>
                                    </div>
                                </div>
    ...
    while($fetch = mysqli_fetch_assoc($query)){       
        ...
        ?>
            <td style="width:30%;">
                <button class=" btn btn-default" data-toggle="tooltip" data-placement="top" title="Click to accept" id="activate_btn_<?php echo $fetch['ID']; ?>" onclick="activate_sms(<?php echo $fetch['ID']; ?>);"><i class="fa fa-edit"></i> Recharge</button>
            </td>
