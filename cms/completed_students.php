...
<?php include '../includes/cms_header.php';
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        <div class="col-sm-12">
                            <form action="completed_students.php" method="get">
                           ...
                           <div class="content">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">Administrator CMS / Student /</span> <span style="color:#3c8dbc">Completed Students - <strong><?php echo $academic_year;?></strong></span>
                                </div>
                            </div>
    ...
    $query1 = mysqli_query($conn,"select * from admitted_students where `SCHOOL`='$initials'   and `YEAR OF COMPLESTION`='$academic_year' order by `STUDENT LAST NAME` asc");
                    ...
                    <ul class="dropdown-menu" id="dropdown" class="dropdown">
                        ...
                        <tr>
                          ...
                          <th>ACTION</th>
                                         ...
                                         <a href="completed_students_list.php?academic_year=<?php echo $academic_year; ?>" target="_blank"><button type="button" class="btn btn-danger"><i class="fa fa-print"></i> Generate report</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(5) ul li:nth-child(3)').toggleClass('active');
             });
