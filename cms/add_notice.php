        ...
        <div class="wrapper">
                        ...
                        <div class="panel-group">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">CMS / Add Notice</span>
                                </div>
                            </div>
                        </div>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body pad">
              <form>
                <textarea class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="notice_box"></textarea><br/><br/>
                  <button type="button" class="btn btn-primary pull-right" id="publish_btn" onclick="add_notice('notice')">Publish</button>
              </form>
            </div>
          </div>
