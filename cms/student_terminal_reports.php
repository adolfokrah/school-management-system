...
<html>
    <head>
        ...
        <title>Easyskul - CMS::Student's Report</title>
...
<?php include '../includes/cms_header.php';
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        if(isset($_GET['academic_year']) && !empty($_GET['academic_year']) && isset($_GET['term']) && !empty($_GET['term'])){
                        ...
                        <div class="content">
                            <div class="col-md-12">
                             <?php 
                                    if($new > 0){
                                        ?>
                                <div class="box box-danger collapsed-box"  data-toggle="tooltip" data-placement="left" title="Click on the plus (+) icon to expand this panel" id="expand_box" >
                                <div class="box-header with-border">
                                  <h5>
                                      You have 
                                  <span class="pull-right-container" >
                                  <span class="label label-danger" data-toggle="tooltip" data-placement="left" title="You have <?php echo $new; ?> new report(s)"><?php echo $new;?></span>
                                      new report(s)
                                      </span></h5>

                                  <div class="box-tools pull-right">
                                    <button type="button" class="btn btn-box-tool"  data-toggle="tooltip" data-placement="top" title="Click here to see reports" id="expand_btn"><i class="fa fa-plus"></i>
                                    </button>
                                  </div>
                                  <!-- /.box-tools -->
                                </div>
                                ...
                                <div class="box-body" style="overflow-y:auto">
                                  <table class="table table-striped table-hover" style="mininum-width:300px;">
                                            <thead>
                                                  <th>ACADEMIC YEAR</th>
                                                  <th>TERM</th>
                                          ...
                                          <tbody>
                                              <?php 
                                                $query = mysqli_query($conn,"select * from terminal_reports_av where `STUDENT ID`='$student_id' and `VIEWED`=''");
                                                ...
                                                <td><a data-toggle="tooltip" data-placement="top" title="Click here to view report"><span class="label label-warning" style="cursor:pointer" data-toggle="modal" data-target="#result" onclick="show_result_box(\''.$id.'\')">View</span></a></td>
                                              </tr>';
                                                }
                                              ?>
                                          </tbody>
                        ...
                        <div class="col-sm-12">
                            ...
                            <form action="student_terminal_reports.php" method="get" class="form-inline" rol="form">
                           ...
                           <div class="content">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">CMS / Terminal Reports  Student ID - <strong> <?php echo $student_id;?></strong></span>
                                </div>
                            </div>
    ...
    $query1 = mysqli_query($conn,"select * from terminal_reports_av where `SCHOOL`='$initials'  and `STUDENT ID`='$student_id' and `VIEWED`!='' order by `TERM` asc");
    ...
    while($fetch1 = mysqli_fetch_assoc($query1)){
        ...
        $academic_year = $fetch1['ACADEMIC YEAR'];
        $term  = $fetch1['TERM'];
        $counter ++;
        $btn = '<a href="print_terminal_report.php?student_id='.$student_id.'&academic_year='.$academic_year.'&term='.$term.'" target="_blank"><button class="btn btn-danger" ><i class="fa fa-print" ></i> View</button></a>';
...
<!--modl boxes-->
         <div class="modal fade" id="result" style="z-index:5000;">
             <div class="modal-dialog " style="z-index:5000;">
                 <div class="modal-content">
                     <div class="modal-header">
                         <button class="close" type="button" data-dismiss="modal"><i class="fa fa-close"></i></button>
                         <h1>Please input voucher code to check result</h1>
                     </div>
                     <div class="modal-body">
                         <form class="form">
                             <div class="form-group">
                                 <input type="text" class="form-control" placeholder="Vocher Code here" id="vcode"/>
                              </div>
                             <div class="form-group">
                                 
                                 <button class="btn btn-primary btn-block" type="button" id="vcode_btn">Continue</button>
             ...
             $('document').ready(function(){
               ...
               // console.log(value.length);
                ...
                $('#expand_btn').on('click',function (){
                    $('#expand_box').toggleClass('collapsed-box');
                })
            });
         </script>
