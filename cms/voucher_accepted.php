...
<head>
    ...
    <title>Easyskul - CMS::Accepted Vouchers</title>
...
<body>
                ...
                <div class="content" style="padding:20px; padding-top:0px;">
                    <div class="col-sm-12">
                        <div class="panel-group">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">Administrator CMS / Voucher /</span> <span style="color:#3c8dbc">Accepted</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="padding-bottom:20px;">
                            <div class="content">
                                <div class="col-xs-12">
                                    <button class="btn btn-danger" type="button" onclick="delete_all_teachers();"><i class="fa fa-trash"></i> Delete All</button>
                                </div>
                            </div>
    ...
    while($fetch = mysqli_fetch_assoc($query)){       
        ...
        ?>
            ...
            <td>
                <button class=" btn btn-primary" data-toggle="tooltip" data-placement="top" title="Click to accept" id="activate_btn_<?php echo $fetch['ID']; ?>" onclick="activate_voucher(<?php echo $fetch['ID']; ?>);"><i class="fa fa-edit"></i> Resubmit</button>
            </td>
            <?php
        echo '</tr>';
    }
