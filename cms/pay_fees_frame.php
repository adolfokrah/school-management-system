...
<div class='copied'></div>
        <div class="wrapper">
            <!-- Sidebar Holder -->
            <?php include '../includes/school_ini_user_id.php'?>
            ...
            <div id="content">
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        <div class="col-sm-12">
                            <form action="pay_fees_frame.php" method="get">
                        ...
                        <div class="content">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b"> School Fees /</span> <span style="color:#3c8dbc">Pay Fees -  <strong><?php echo $initial_class;?></strong></span><br/>
                                </div>
                                <div class="panel panel-body">
                                   
                                    <strong>You can click on the copy button containig student ID to select it, then right click and select copy from the popup options </strong>
                                </div>
    ...
    while($fetch1 = mysqli_fetch_assoc($query1)){
        ...
        echo '<tr id="row'.$id.'">
              ...
              <td>'.$counter.'</td>
              <td><button type="button" class="btn btn-success" onclick="copyToClipboard(\'#sid_'.$id.'\')"><i class="fa fa-copy"></i></button> <span id="sid_'.$id.'">'.$student_id.'</span></td>
...
<!--modl boxes-->
        <input id="copytext" style="position:fixed; top:1000000px"/>
