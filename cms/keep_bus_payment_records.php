...
<html>
    <head>
        ...
        <title>Easyskul - CMS::Keep Bus fee records</title>
...
<?php include '../includes/cms_header.php';
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        <ol class="breadcrumb"><i class="fa fa-car"></i> Transport <small> - Keep Bus fee</small></ol>
                        
                       <div class="col-xs-12 col-sm-10 col-sm-offset-1" style="padding-top:40px; padding-bottom:50px; background-color:white;">
                            <form >
                               ...
                               <div class="form-group"> 
                                     ...
                                     <div class="form-group">
                                <label><small>Pick Category</small></label><br/>
                           <select class="selectpicker" data-width="100%" data-show-subtext="true" data-live-search="true" style="width:100%;" id="cat" name="class">
                            ...
                            <div class="form-group">
                                ...
                                <label><small>Pick bus</small></label><br/>
                           <select class="selectpicker" data-width="100%" data-show-subtext="true" data-live-search="true" style="width:100%;" id="bus" name="class">
                            <?php
                                   
                                    $qeuery_pick_classes = mysqli_query($conn,"select * from busses where `SCHOOL`='$initials' order by ID asc");
                                    while($fetch = mysqli_fetch_assoc($qeuery_pick_classes)){
                                        echo '<option value="'.htmlentities($fetch['BUS NUMBER']).'" data-subtext="'.htmlentities($fetch['LOCATIONS']).'">'.htmlentities($fetch['BUS NUMBER']).'</option>';
                                    }
                            ...
                            <div class="form-group"> 
                                      <input type="text" class="form-control" placeholder="Location" id="location"><br/>
                                <a href="https://www.google.com/maps/place/Ghana/@7.04229,-1.220977,7z/data=!4m5!3m4!1s0xfd75acda8dad6c7:0x54d7f230d093d236!8m2!3d7.946527!4d-1.023194?hl=en" target="_blank"><div class="label label-warning pull-right" data-toggle="tooltip" data-replacement="top" title="Copy location from map"><i class="fa fa-map-marker"></i></div></a>
                                    </div>
                            
                            <br/>
                             <button type="button" class="btn btn-primary btn-block" id="Continue" onclick="keep_bus_fee()">Continue</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div id="content">
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:20px;">
                        ...
                        <div class="col-sm-12">
                            <form action="keep_bus_payment_records" method="get">
                           ...
                           <button type="submit" class="btn btn-default">Search</button>
                              <a href="print_bus_fee_sheet.php?class=<?php echo $initial_class;?>" target="_blank"><button type="button" class="btn btn-danger pull-right" id="print_feeding_sheet_btn" data-toggle="tooltip" data-placement="left" title="Payment Sheet allows you to know days left for student who have payment for extra days and also know how much each student is paying. Please print payment sheet before you insert bus fee records, since the records you insert must correspond to the payment sheet."><i class="fa fa-print"></i> Generate Payment sheet</button></a>
                        </form>
                        </div>
                        <div class="content">
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(11) ul li:nth-child(3)').toggleClass('active');
             });
