...
<?php include '../includes/cms_header.php';
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        if(isset($_GET['academic_year']) && !empty($_GET['academic_year'])){
                            $academic_year = $_GET['academic_year'];
                                ...
                                $academic_year = '';
                                $query_pick_initial_class = mysqli_query($conn,"select * from academic_years where `SCHOOL`='$initials' order by ID desc");
                        ...
                        <div class="col-sm-12">
                            <form action="admitted_students.php" method="get">
                           ...
                           <div class="content">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b">Administrator CMS / Student /</span> <span style="color:#3c8dbc">Admittion History - <strong><?php echo $academic_year;?></strong></span>
                                </div>
                            </div>
    ...
    $query1 = mysqli_query($conn,"select * from admitted_students where `SCHOOL`='$initials'   and `ACADEMIC YEAR`='$academic_year' order by `STUDENT LAST NAME` asc");
    ...
    while($fetch1 = mysqli_fetch_assoc($query1)){
        ...
        $class = htmlentities($fetch1['CLASS ADMITTED']);
                    ...
                    <ul class="dropdown-menu" id="dropdown" class="dropdown">
                        ...
                        <tr>
                          ...
                          <th>ACTION</th>
                                         ...
                                         <a href="print_students_list.php?action=admission_list&academic_year=<?php echo $academic_year; ?>&class=" target="_blank"><button type="button" class="btn btn-danger"><i class="fa fa-print"></i> Generate report</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(5) ul li:nth-child(2)').toggleClass('active');
             });
