...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
            <!-- Sidebar Holder -->
            <?php 
            $users = array("Administrator","School Head");
...
<?php include '../includes/cms_header.php';
                ...
                <div id="box">
                    ...
                    <div class="content" style="padding:20px; padding-top:0px;">
                        ...
                        <div class="col-sm-12">
                            <form action="histories.php" method="get" class="form-inline" role="form">
                        ...
                        <div class="col-sm-12" style="padding-top:20px;">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span style="color:#6b6b6b"><?php echo $username; ?> CMS / Operation Histories </span> <span style="color:#3c8dbc"> - <strong> <?php echo $from;?> - <?php echo $to;?></strong></span>
                                </div>
                            </div>
                        ...
                        <div class="content">
                            <div class="col-sm-12">
                            <button type="button" class="btn btn-danger pull-right" onclick="delete_history();" <?php echo $btn_style;?>><i class="fa fa-trash"></i> Delete</button>
                        ...
                        <tbody id="result_box">
                            ...
                            <?php
                                 $results = '';
                                $counter  = 0;
                                $query_pick_fees = mysqli_query($conn,"select * from histories where `DATE` between '$from' and '$to' and `SCHOOL`= '$initials' order by  `ID` asc");
                            
                                
                                while($fetch = mysqli_fetch_assoc($query_pick_fees)){
                                    $id = $fetch['ID'];
                                    $counter ++;
                                        $results .= '<tr id="row'.$id.'">
                                        <td><label>
                  <input type="checkbox" id="row_check" name="'.$id.'" class="checkboxes">  <i class="fa fa-check"></i>
              </label> </td>
                                        <td>'.$counter.'</td>
                                        
                                        <td>'.htmlentities($fetch['USER ID']).'</td>
                                        <td>'.($fetch['OPERATION']).'</td>
                                        <td>'.htmlentities($fetch['DATE']).'</td>
                                        <td>'.htmlentities($fetch['TIME']).'</td>
        ...
        <script src="../js/webcam_config.js"></script>
         <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('.list-unstyled li:nth-child(25)').toggleClass('active');
             });
